    @auth
        <nav class="nav-atas">
            <a class="navbar-brand mx-4" href="/home"><img src="{{asset('coffeeAroundU/assets/logo/coffeebeans.png')}}" width="80px" height="80px" alt="logo-coffeAroungU"></a>
            <ul>
        ...
        @guest
            <nav class="navbar navbar-expand-lg bg-white ">
                <div class="container-fluid">
                    <a class="navbar-brand mx-4" href="/"><img src="{{asset('coffeeAroundU/assets/logo/coffeebeans.png')}}" width="80px" height="80px" alt="logo-coffeAroungU"></a>
