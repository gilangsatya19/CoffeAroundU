    ...
    <nav class="navbar navbar-expand-lg bg-white ">
        <div class="container-fluid">
            <a class="navbar-brand mx-4" href="/"><img
                    ...
                    width="90px" height="90px" alt="logo-coffeAroungU"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div>
                    <img class="style-scope mx-3" src="{{asset('coffeeAroundU/assets/navbar/icon_account.png')}}"
            ...
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div>
                        <img class="mx-5"
                            src="https://cdn.icon-icons.com/icons2/2620/PNG/512/among_us_player_red_icon_156942.png"
                            style="object-position: bot right;" width="150px" height="150px" alt="">
                    </div>
