    ...
    <form action="/{{$action}}" method="{{$method}}">
        <div class="container-fluid ">
            <div class="container d-flex justify-content-center my-5">
                <div class="my-3">
                    <p class="fw-bold mb-5 text-center" style="font-size: 50px">{{$title}}</p>
                    <div class="mb-5 border border-2 border-black" style="height:24rem;width:60rem;align-items:center">
                        <div class="mx-5 my-5 ">
                            ...
                            <div>
                                <button class="btn btn-primary fw-semibold px-4 mt-5" style="background-color: #4A2C2A" type="submit">Submit</button>
                            </div>
                        </div>
                    </div>
                </div>  
